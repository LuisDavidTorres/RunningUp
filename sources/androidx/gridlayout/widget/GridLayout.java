...
import androidx.gridlayout.C0423R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0423R.styleable.GridLayout_alignmentMode;
    ...
    private static final int COLUMN_COUNT = C0423R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0423R.styleable.GridLayout_columnOrderPreserved;
    ...
    private static final int ORIENTATION = C0423R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT;
    private static final int ROW_COUNT = C0423R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0423R.styleable.GridLayout_rowOrderPreserved;
    ...
    private static final int USE_DEFAULT_MARGINS = C0423R.styleable.GridLayout_useDefaultMargins;
    ...
    public GridLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0423R.dimen.default_gap);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0423R.styleable.GridLayout);
        try {
    ...
    final class Axis {
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc<K, V> of = Assoc.m11of(Spec.class, Bounds.class);
            int childCount = GridLayout.this.getChildCount();
        ...
        private PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc<K, V> of = Assoc.m11of(Interval.class, MutableInt.class);
        ...
        private String arcsToString(List<Arc> list) {
            ...
            for (Arc next : list) {
                ...
                if (i < i2) {
                    sb2 = sb.append(str).append(i2).append("-").append(str).append(i).append(">=");
                } else {
                    sb = new StringBuilder();
                    sb2 = sb.append(str).append(i).append("-").append(str).append(i2).append("<=");
                    i3 = -i3;
                }
                sb3.append(sb2.append(i3).toString());
            }
            return sb3.toString();
        }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0423R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0423R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0423R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0423R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0423R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0423R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0423R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0423R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0423R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0423R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0423R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0423R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0423R.styleable.GridLayout_Layout);
            try {
    ...
    static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        /* renamed from: of */
        public static <K, V> Assoc<K, V> m11of(Class<K> cls, Class<V> cls2) {
