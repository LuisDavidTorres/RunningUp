...
public class MotionController {
    ...
    public KeyPositionBase getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        rectF.left = this.mStartMotionPath.f53x;
        rectF.top = this.mStartMotionPath.f54y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f53x;
        rectF2.top = this.mEndMotionPath.f54y;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f53x - this.mStartMotionPath.f53x;
        float f4 = this.mEndMotionPath.f54y - this.mStartMotionPath.f54y;
        float f5 = this.mStartMotionPath.f53x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f54y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f53x - this.mStartMotionPath.f53x;
        float f6 = this.mEndMotionPath.f54y - this.mStartMotionPath.f54y;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f7 = this.mEndMotionPath.f53x - this.mStartMotionPath.f53x;
            float f8 = this.mEndMotionPath.f54y - this.mStartMotionPath.f54y;
