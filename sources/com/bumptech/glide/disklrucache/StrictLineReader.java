...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f88CR = 13;

    /* renamed from: LF */
    private static final byte f89LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f90in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f90in) {
            if (this.buf != null) {
                ...
                C06891 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f90in;
        byte[] bArr = this.buf;
