...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void begin() {
        /*
            ...
            monitor-enter(r0)
            r4.assertNotCallingCallbacks()     // Catch:{ all -> 0x00b2 }
            com.bumptech.glide.util.pool.StateVerifier r1 = r4.stateVerifier     // Catch:{ all -> 0x00b2 }
            r1.throwIfRecycled()     // Catch:{ all -> 0x00b2 }
            long r1 = com.bumptech.glide.util.LogTime.getLogTime()     // Catch:{ all -> 0x00b2 }
            r4.startTime = r1     // Catch:{ all -> 0x00b2 }
            java.lang.Object r1 = r4.model     // Catch:{ all -> 0x00b2 }
            if (r1 != 0) goto L_0x003c
            int r1 = r4.overrideWidth     // Catch:{ all -> 0x00b2 }
            int r2 = r4.overrideHeight     // Catch:{ all -> 0x00b2 }
            boolean r1 = com.bumptech.glide.util.Util.isValidDimensions(r1, r2)     // Catch:{ all -> 0x00b2 }
            if (r1 == 0) goto L_0x0027
            int r1 = r4.overrideWidth     // Catch:{ all -> 0x00b2 }
            r4.width = r1     // Catch:{ all -> 0x00b2 }
            int r1 = r4.overrideHeight     // Catch:{ all -> 0x00b2 }
            r4.height = r1     // Catch:{ all -> 0x00b2 }
        L_0x0027:
            android.graphics.drawable.Drawable r1 = r4.getFallbackDrawable()     // Catch:{ all -> 0x00b2 }
        ...
        L_0x002f:
            r1 = 3
        L_0x0030:
            com.bumptech.glide.load.engine.GlideException r2 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00b2 }
            java.lang.String r3 = "Received null model"
            r2.<init>(r3)     // Catch:{ all -> 0x00b2 }
            r4.onLoadFailed(r2, r1)     // Catch:{ all -> 0x00b2 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b2 }
            return
        L_0x003c:
            com.bumptech.glide.request.SingleRequest$Status r1 = r4.status     // Catch:{ all -> 0x00b2 }
            com.bumptech.glide.request.SingleRequest$Status r2 = com.bumptech.glide.request.SingleRequest.Status.RUNNING     // Catch:{ all -> 0x00b2 }
            if (r1 == r2) goto L_0x00aa
            com.bumptech.glide.request.SingleRequest$Status r1 = r4.status     // Catch:{ all -> 0x00b2 }
            com.bumptech.glide.request.SingleRequest$Status r2 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch:{ all -> 0x00b2 }
            if (r1 != r2) goto L_0x0052
            com.bumptech.glide.load.engine.Resource<R> r1 = r4.resource     // Catch:{ all -> 0x00b2 }
            com.bumptech.glide.load.DataSource r2 = com.bumptech.glide.load.DataSource.MEMORY_CACHE     // Catch:{ all -> 0x00b2 }
            r3 = 0
            r4.onResourceReady(r1, r2, r3)     // Catch:{ all -> 0x00b2 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b2 }
            return
        L_0x0052:
            com.bumptech.glide.request.SingleRequest$Status r1 = com.bumptech.glide.request.SingleRequest.Status.WAITING_FOR_SIZE     // Catch:{ all -> 0x00b2 }
            r4.status = r1     // Catch:{ all -> 0x00b2 }
            int r1 = r4.overrideWidth     // Catch:{ all -> 0x00b2 }
            int r2 = r4.overrideHeight     // Catch:{ all -> 0x00b2 }
            boolean r1 = com.bumptech.glide.util.Util.isValidDimensions(r1, r2)     // Catch:{ all -> 0x00b2 }
            ...
            int r1 = r4.overrideWidth     // Catch:{ all -> 0x00b2 }
            int r2 = r4.overrideHeight     // Catch:{ all -> 0x00b2 }
            r4.onSizeReady(r1, r2)     // Catch:{ all -> 0x00b2 }
            goto L_0x006d
        L_0x0068:
            com.bumptech.glide.request.target.Target<R> r1 = r4.target     // Catch:{ all -> 0x00b2 }
            r1.getSize(r4)     // Catch:{ all -> 0x00b2 }
        L_0x006d:
            com.bumptech.glide.request.SingleRequest$Status r1 = r4.status     // Catch:{ all -> 0x00b2 }
            com.bumptech.glide.request.SingleRequest$Status r2 = com.bumptech.glide.request.SingleRequest.Status.RUNNING     // Catch:{ all -> 0x00b2 }
            if (r1 == r2) goto L_0x0079
            com.bumptech.glide.request.SingleRequest$Status r1 = r4.status     // Catch:{ all -> 0x00b2 }
            com.bumptech.glide.request.SingleRequest$Status r2 = com.bumptech.glide.request.SingleRequest.Status.WAITING_FOR_SIZE     // Catch:{ all -> 0x00b2 }
            if (r1 != r2) goto L_0x0088
        L_0x0079:
            boolean r1 = r4.canNotifyStatusChanged()     // Catch:{ all -> 0x00b2 }
            if (r1 == 0) goto L_0x0088
            com.bumptech.glide.request.target.Target<R> r1 = r4.target     // Catch:{ all -> 0x00b2 }
            android.graphics.drawable.Drawable r2 = r4.getPlaceholderDrawable()     // Catch:{ all -> 0x00b2 }
            r1.onLoadStarted(r2)     // Catch:{ all -> 0x00b2 }
        L_0x0088:
            boolean r1 = IS_VERBOSE_LOGGABLE     // Catch:{ all -> 0x00b2 }
            ...
            long r2 = r4.startTime     // Catch:{ all -> 0x00b2 }
            double r2 = com.bumptech.glide.util.LogTime.getElapsedMillis(r2)     // Catch:{ all -> 0x00b2 }
            java.lang.StringBuilder r1 = r1.append(r2)     // Catch:{ all -> 0x00b2 }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x00b2 }
            r4.logV(r1)     // Catch:{ all -> 0x00b2 }
        L_0x00a8:
            monitor-exit(r0)     // Catch:{ all -> 0x00b2 }
            return
        L_0x00aa:
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r6, com.bumptech.glide.load.DataSource r7, boolean r8) {
        /*
            ...
            r5.loadStatus = r0     // Catch:{ all -> 0x00c3 }
            if (r6 != 0) goto L_0x0032
            com.bumptech.glide.load.engine.GlideException r6 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00c3 }
            ...
            java.lang.Class<R> r8 = r5.transcodeClass     // Catch:{ all -> 0x00c3 }
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x00c3 }
            java.lang.String r8 = " inside, but instead got null."
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x00c3 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x00c3 }
            r6.<init>(r7)     // Catch:{ all -> 0x00c3 }
            r5.onLoadFailed(r6)     // Catch:{ all -> 0x00c3 }
            monitor-exit(r1)     // Catch:{ all -> 0x00c3 }
            return
        L_0x0032:
            java.lang.Object r2 = r6.get()     // Catch:{ all -> 0x00c3 }
            if (r2 == 0) goto L_0x005f
            java.lang.Class<R> r3 = r5.transcodeClass     // Catch:{ all -> 0x00c3 }
            java.lang.Class r4 = r2.getClass()     // Catch:{ all -> 0x00c3 }
            boolean r3 = r3.isAssignableFrom(r4)     // Catch:{ all -> 0x00c3 }
            if (r3 != 0) goto L_0x0045
            goto L_0x005f
        L_0x0045:
            boolean r3 = r5.canSetResource()     // Catch:{ all -> 0x00c3 }
            if (r3 != 0) goto L_0x005a
            r5.resource = r0     // Catch:{ all -> 0x00bf }
            com.bumptech.glide.request.SingleRequest$Status r7 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch:{ all -> 0x00bf }
            r5.status = r7     // Catch:{ all -> 0x00bf }
        ...
        L_0x0059:
            return
        L_0x005a:
            r5.onResourceReady(r6, r2, r7, r8)     // Catch:{ all -> 0x00c3 }
            monitor-exit(r1)     // Catch:{ all -> 0x00c3 }
            return
        L_0x005f:
            r5.resource = r0     // Catch:{ all -> 0x00bf }
            com.bumptech.glide.load.engine.GlideException r7 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00bf }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ all -> 0x00bf }
            r8.<init>()     // Catch:{ all -> 0x00bf }
            java.lang.String r0 = "Expected to receive an object of "
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00bf }
            java.lang.Class<R> r0 = r5.transcodeClass     // Catch:{ all -> 0x00bf }
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00bf }
            java.lang.String r0 = " but instead got "
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00bf }
            if (r2 == 0) goto L_0x0081
            java.lang.Class r0 = r2.getClass()     // Catch:{ all -> 0x00bf }
            goto L_0x0083
        L_0x0081:
            java.lang.String r0 = ""
        L_0x0083:
            ...
            java.lang.String r0 = "{"
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00bf }
            java.lang.StringBuilder r8 = r8.append(r2)     // Catch:{ all -> 0x00bf }
            java.lang.String r0 = "} inside Resource{"
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00bf }
            java.lang.StringBuilder r8 = r8.append(r6)     // Catch:{ all -> 0x00bf }
            java.lang.String r0 = "}."
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00bf }
        ...
        L_0x00a8:
            ...
            r7.<init>(r8)     // Catch:{ all -> 0x00bf }
            r5.onLoadFailed(r7)     // Catch:{ all -> 0x00bf }
            monitor-exit(r1)     // Catch:{ all -> 0x00bf }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x00b4 A[Catch:{ all -> 0x00c5 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r10, R r11, com.bumptech.glide.load.DataSource r12, boolean r13) {
        ...
        L_0x0077:
            ...
            r6 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r9.requestListeners     // Catch:{ all -> 0x00c5 }
            if (r0 == 0) goto L_0x009d
            java.util.Iterator r7 = r0.iterator()     // Catch:{ all -> 0x00c5 }
            r8 = r6
        L_0x0084:
            boolean r0 = r7.hasNext()     // Catch:{ all -> 0x00c5 }
            if (r0 == 0) goto L_0x009e
            java.lang.Object r0 = r7.next()     // Catch:{ all -> 0x00c5 }
            com.bumptech.glide.request.RequestListener r0 = (com.bumptech.glide.request.RequestListener) r0     // Catch:{ all -> 0x00c5 }
            java.lang.Object r2 = r9.model     // Catch:{ all -> 0x00c5 }
            com.bumptech.glide.request.target.Target<R> r3 = r9.target     // Catch:{ all -> 0x00c5 }
            r1 = r11
            r4 = r12
            r5 = r13
            boolean r0 = r0.onResourceReady(r1, r2, r3, r4, r5)     // Catch:{ all -> 0x00c5 }
            r8 = r8 | r0
            goto L_0x0084
        L_0x009d:
            r8 = r6
        L_0x009e:
            com.bumptech.glide.request.RequestListener<R> r0 = r9.targetListener     // Catch:{ all -> 0x00c5 }
        ...
        L_0x00b1:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r10 = r9.animationFactory     // Catch:{ all -> 0x00c5 }
            com.bumptech.glide.request.transition.Transition r10 = r10.build(r12, r13)     // Catch:{ all -> 0x00c5 }
            com.bumptech.glide.request.target.Target<R> r12 = r9.target     // Catch:{ all -> 0x00c5 }
            r12.onResourceReady(r11, r10)     // Catch:{ all -> 0x00c5 }
        L_0x00bf:
