...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f93ix = readShort();
        this.header.currentFrame.f94iy = readShort();
        this.header.currentFrame.f92iw = readShort();
        this.header.currentFrame.f91ih = readShort();
        int read = read();
        boolean z = false;
