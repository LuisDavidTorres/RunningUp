...
public final class DynamiteModule {
    ...
    public static int zza(android.content.Context r8, java.lang.String r9, boolean r10) {
        /*
            ...
            java.lang.Boolean r1 = zziu     // Catch:{ all -> 0x00ff }
        ...
        L_0x00a2:
            ...
            java.lang.StringBuilder r1 = r3.append(r1)     // Catch:{ all -> 0x00ff }
        ...
        L_0x00f5:
            ...
            return r8
        L_0x00fa:
            int r8 = zzb((android.content.Context) r8, (java.lang.String) r9, (boolean) r10)     // Catch:{ all -> 0x0102 }
            return r8
        L_0x00ff:
            r9 = move-exception
            monitor-exit(r0)     // Catch:{ all -> 0x00ff }
    ...
    private static int zzc(android.content.Context r8, java.lang.String r9, boolean r10) throws com.google.android.gms.dynamite.DynamiteModule.LoadingException {
        ...
        L_0x000c:
            int r10 = r8.length()     // Catch:{ Exception -> 0x00a1, all -> 0x009f }
            int r10 = r10 + 42
            ...
            java.lang.StringBuilder r10 = r2.append(r10)     // Catch:{ Exception -> 0x00a1, all -> 0x009f }
            java.lang.StringBuilder r8 = r10.append(r8)     // Catch:{ Exception -> 0x00a1, all -> 0x009f }
            java.lang.String r10 = "/"
            java.lang.StringBuilder r8 = r8.append(r10)     // Catch:{ Exception -> 0x00a1, all -> 0x009f }
            java.lang.StringBuilder r8 = r8.append(r9)     // Catch:{ Exception -> 0x00a1, all -> 0x009f }
            java.lang.String r8 = r8.toString()     // Catch:{ Exception -> 0x00a1, all -> 0x009f }
            ...
            zzix = r1     // Catch:{ all -> 0x007d }
            java.lang.String r1 = "loaderVersion"
            int r1 = r8.getColumnIndex(r1)     // Catch:{ all -> 0x007d }
            if (r1 < 0) goto L_0x006b
            int r1 = r8.getInt(r1)     // Catch:{ all -> 0x007d }
            zziy = r1     // Catch:{ all -> 0x007d }
        L_0x006b:
            monitor-exit(r10)     // Catch:{ all -> 0x007d }
            java.lang.ThreadLocal<com.google.android.gms.dynamite.DynamiteModule$zza> r10 = zziz     // Catch:{ Exception -> 0x009a, all -> 0x0096 }
            ...
            android.database.Cursor r1 = r10.zzjd     // Catch:{ Exception -> 0x009a, all -> 0x0096 }
            if (r1 != 0) goto L_0x0080
            r10.zzjd = r8     // Catch:{ Exception -> 0x009a, all -> 0x0096 }
            goto L_0x0081
        L_0x007d:
            r9 = move-exception
            monitor-exit(r10)     // Catch:{ all -> 0x007d }
