...
public final class CollectionUtils {
    ...
    public static <K, V> Map<K, V> mapOfKeyValueArrays(K[] kArr, V[] vArr) {
        ...
        throw new IllegalArgumentException(new StringBuilder(66).append("Key and values array lengths not equal: ").append(length2).append(" != ").append(vArr.length).toString());
    }
}
