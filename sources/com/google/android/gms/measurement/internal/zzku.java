...
public final class zzku extends zzki {
        ...
        if (list != null) {
            ...
            for (zzfs next : list) {
                if (next != null) {
                    ...
                    sb.append("param {\n");
                    Double d = null;
                    zzJ(sb, i2, AppMeasurementSdk.ConditionalUserProperty.NAME, next.zzx() ? this.zzs.zzj().zze(next.zzg()) : null);
                    zzJ(sb, i2, "string_value", next.zzy() ? next.zzh() : null);
                    zzJ(sb, i2, "int_value", next.zzw() ? Long.valueOf(next.zzd()) : null);
                    if (next.zzu()) {
        ...
        if (zzgd != null) {
            ...
            if (zzgd.zza() != 0) {
                ...
                for (zzfm next3 : zzgd.zzj()) {
                    ...
                    sb.append(next3.zzh() ? Integer.valueOf(next3.zza()) : null);
                    sb.append(":");
            ...
            if (zzgd.zzc() != 0) {
                ...
                for (zzgf next4 : zzgd.zzm()) {
                    ...
                    sb.append(next4.zzi() ? Integer.valueOf(next4.zzb()) : null);
                    sb.append(": [");
                    int i10 = 0;
    ...
    public final <T extends android.os.Parcelable> T zzh(byte[] r5, android.os.Parcelable.Creator<T> r6) {
        /*
            r4 = this;
            r0 = 0
        ...
        L_0x001a:
            ...
            goto L_0x002f
        L_0x001c:
            com.google.android.gms.measurement.internal.zzfv r5 = r4.zzs     // Catch:{ all -> 0x001a }
            com.google.android.gms.measurement.internal.zzel r5 = r5.zzay()     // Catch:{ all -> 0x001a }
            com.google.android.gms.measurement.internal.zzej r5 = r5.zzd()     // Catch:{ all -> 0x001a }
        ...
        L_0x002f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzku.zzh(byte[], android.os.Parcelable$Creator):android.os.Parcelable");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final com.google.android.gms.measurement.internal.zzat zzi(com.google.android.gms.internal.measurement.zzaa r9) {
        /*
            r8 = this;
        ...
        L_0x001e:
            ...
            java.lang.String r1 = com.google.android.gms.measurement.internal.zzgs.zzb(r1)
        ...
        L_0x002d:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzku.zzi(com.google.android.gms.internal.measurement.zzaa):com.google.android.gms.measurement.internal.zzat");
    }
                ...
                if (zzP != null) {
                    for (zzgh next2 : zzP) {
                        if (next2 != null) {
                            ...
                            zzJ(sb, 2, "set_timestamp_millis", next2.zzs() ? Long.valueOf(next2.zzc()) : null);
                            zzJ(sb, 2, AppMeasurementSdk.ConditionalUserProperty.NAME, this.zzs.zzj().zzf(next2.zzf()));
                            zzJ(sb, 2, "string_value", next2.zzg());
                            zzJ(sb, 2, "int_value", next2.zzr() ? Long.valueOf(next2.zzb()) : null);
                            zzJ(sb, 2, "double_value", next2.zzq() ? Double.valueOf(next2.zza()) : null);
                            zzG(sb, 2);
                            sb.append("}\n");
                        }
                    }
