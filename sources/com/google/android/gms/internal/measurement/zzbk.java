...
public final class zzbk extends zzaw {
    ...
    public final zzap zza(String str, zzg zzg, List<zzap> list) {
        ...
        if (ordinal == 3) {
            ...
            zzap zzb6 = zzg.zzb(list.get(1));
            zzap zzb7 = zzg.zzb(list.get(2));
            ...
            if (ordinal != 18) {
                ...
                switch (ordinal) {
                    ...
                    case 64:
                        ...
                        for (zzap zzb11 : list) {
                            zzap zzb12 = zzg.zzb(zzb11);
                            if (zzb12 instanceof zzat) {
                                zzg.zze(zzb12.zzi(), zzap.zzf);
                            } else {
                                throw new IllegalArgumentException(String.format("Expected string for var name. got %s", new Object[]{zzb12.getClass().getCanonicalName()}));
                            }
                        }
                        return zzap.zzf;
                    default:
                ...
                if (list.size() % 2 == 0) {
                    zzam zzam = new zzam();
                    while (i < list.size() - 1) {
                        zzap zzb13 = zzg.zzb(list.get(i));
                        zzap zzb14 = zzg.zzb(list.get(i + 1));
                        if ((zzb13 instanceof zzag) || (zzb14 instanceof zzag)) {
                            throw new IllegalStateException("Failed to evaluate map entry");
                        }
                        zzam.zzr(zzb13.zzi(), zzb14);
                        i += 2;
                    }
                    return zzam;
                }
