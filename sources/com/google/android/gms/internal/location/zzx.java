...
final class zzx extends zzab {
    ...
    public final /* synthetic */ void doExecute(Api.AnyClient anyClient) throws RemoteException {
        ...
        ((zzaz) anyClient).zza(zzbd.zza(this.zzck), (ListenerHolder<LocationCallback>) ListenerHolders.createListenerHolder(this.zzcm, zzbm.zza(this.zzcp), "LocationCallback"), (zzaj) new zzac(this));
    }
}
