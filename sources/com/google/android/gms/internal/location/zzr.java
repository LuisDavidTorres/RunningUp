...
final class zzr extends zzab {
    ...
    public final /* synthetic */ void doExecute(Api.AnyClient anyClient) throws RemoteException {
        ...
        ((zzaz) anyClient).zza(this.zzck, (ListenerHolder<LocationListener>) ListenerHolders.createListenerHolder(this.zzcl, zzbm.zzc(), "LocationListener"), (zzaj) new zzac(this));
    }
}
