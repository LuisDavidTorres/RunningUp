...
public final class zzbv extends zza implements IStreetViewPanoramaDelegate {
    ...
    public final StreetViewPanoramaCamera getPanoramaCamera() throws RemoteException {
        ...
        StreetViewPanoramaCamera streetViewPanoramaCamera = (StreetViewPanoramaCamera) zzc.zzc(zzH, StreetViewPanoramaCamera.CREATOR);
        zzH.recycle();
    ...
    public final StreetViewPanoramaLocation getStreetViewPanoramaLocation() throws RemoteException {
        ...
        StreetViewPanoramaLocation streetViewPanoramaLocation = (StreetViewPanoramaLocation) zzc.zzc(zzH, StreetViewPanoramaLocation.CREATOR);
        zzH.recycle();
    ...
    public final StreetViewPanoramaOrientation pointToOrientation(IObjectWrapper iObjectWrapper) throws RemoteException {
        ...
        StreetViewPanoramaOrientation streetViewPanoramaOrientation = (StreetViewPanoramaOrientation) zzc.zzc(zzH, StreetViewPanoramaOrientation.CREATOR);
        zzH.recycle();
