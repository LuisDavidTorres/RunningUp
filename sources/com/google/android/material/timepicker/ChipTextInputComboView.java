...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip2 = (Chip) from.inflate(C0769R.layout.material_time_chip, this, false);
        this.chip = chip2;
        TextInputLayout textInputLayout2 = (TextInputLayout) from.inflate(C0769R.layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C0769R.C0772id.material_label);
