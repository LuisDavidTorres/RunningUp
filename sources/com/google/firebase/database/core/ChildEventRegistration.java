...
public class ChildEventRegistration extends EventRegistration {
    ...
    public void fireEvent(DataEvent dataEvent) {
        if (!isZombied()) {
            int i = C11261.f145x916339dc[dataEvent.getEventType().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C11261 {
        ...
        static final /* synthetic */ int[] f145x916339dc;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f145x916339dc     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f145x916339dc     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f145x916339dc     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.database.core.ChildEventRegistration.C11261.<clinit>():void");
        }
    }
