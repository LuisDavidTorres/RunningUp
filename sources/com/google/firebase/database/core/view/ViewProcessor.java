...
public class ViewProcessor {
    ...
    public ProcessorResult applyOperation(ViewCache viewCache, Operation operation, WriteTreeRef writeTreeRef, Node node) {
        ...
        int i = C12112.f149xc0d7b136[operation.getType().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C12112 {
        ...
        static final /* synthetic */ int[] f149xc0d7b136;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f149xc0d7b136     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f149xc0d7b136     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f149xc0d7b136     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.database.core.view.ViewProcessor.C12112.<clinit>():void");
        }
    }
    ...
    private static class WriteTreeCompleteChildSource implements NodeFilter.CompleteChildSource {
        ...
        public Node getCompleteChild(ChildKey childKey) {
            ...
            if (this.optCompleteServerCache != null) {
                cacheNode = new CacheNode(IndexedNode.from(this.optCompleteServerCache, KeyIndex.getInstance()), true, false);
            } else {
