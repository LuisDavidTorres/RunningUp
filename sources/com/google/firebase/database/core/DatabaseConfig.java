    ...
    static /* synthetic */ class C11301 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.database.core.DatabaseConfig.C11301.<clinit>():void");
        }
    }

    public synchronized void setLogLevel(Logger.Level level) {
        assertUnfrozen();
        int i = C11301.$SwitchMap$com$google$firebase$database$Logger$Level[level.ordinal()];
        if (i == 1) {
