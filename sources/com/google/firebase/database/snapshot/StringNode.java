...
public class StringNode extends LeafNode<StringNode> {
    ...
    static /* synthetic */ class C12191 {
        ...
        static final /* synthetic */ int[] f153x2aed15f4;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f153x2aed15f4     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.database.snapshot.StringNode.C12191.<clinit>():void");
        }
    }

    public String getHashRepresentation(Node.HashVersion hashVersion) {
        int i = C12191.f153x2aed15f4[hashVersion.ordinal()];
        if (i == 1) {
