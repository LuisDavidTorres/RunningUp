...
public class WebSocket {
    ...
    static /* synthetic */ class C12243 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.database.tubesock.WebSocket.C12243.<clinit>():void");
        }
    }

    public synchronized void close() {
        int i = C12243.$SwitchMap$com$google$firebase$database$tubesock$WebSocket$State[this.state.ordinal()];
        if (i == 1) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x00c9, code lost:
        if (r3.hasNext() == false) goto L_0x00ec;
     */
    ...
    public void runReader() {
        /*
            r11 = this;
            java.net.Socket r0 = r11.createSocket()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            monitor-enter(r11)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r11.socket = r0     // Catch:{ all -> 0x0113 }
            com.google.firebase.database.tubesock.WebSocket$State r1 = r11.state     // Catch:{ all -> 0x0113 }
            com.google.firebase.database.tubesock.WebSocket$State r2 = com.google.firebase.database.tubesock.WebSocket.State.DISCONNECTED     // Catch:{ all -> 0x0113 }
        ...
        L_0x001a:
            r0 = move-exception
            java.lang.RuntimeException r1 = new java.lang.RuntimeException     // Catch:{ all -> 0x0113 }
            r1.<init>(r0)     // Catch:{ all -> 0x0113 }
            throw r1     // Catch:{ all -> 0x0113 }
        L_0x0021:
            monitor-exit(r11)     // Catch:{ all -> 0x0113 }
            java.io.DataInputStream r1 = new java.io.DataInputStream     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.io.InputStream r2 = r0.getInputStream()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r1.<init>(r2)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.io.OutputStream r0 = r0.getOutputStream()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            com.google.firebase.database.tubesock.WebSocketHandshake r2 = r11.handshake     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            byte[] r2 = r2.getHandshake()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r0.write(r2)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r2 = 1000(0x3e8, float:1.401E-42)
            byte[] r3 = new byte[r2]     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.util.ArrayList r4 = new java.util.ArrayList     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r4.<init>()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r5 = 0
            r6 = r5
            r7 = r6
        L_0x0044:
            ...
            int r9 = r1.read()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r10 = -1
            if (r9 == r10) goto L_0x00a6
            byte r9 = (byte) r9     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r3[r7] = r9     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            int r7 = r7 + 1
            int r9 = r7 + -1
            byte r9 = r3[r9]     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r10 = 10
            ...
            r10 = 13
            if (r9 != r10) goto L_0x0083
            java.lang.String r7 = new java.lang.String     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.nio.charset.Charset r9 = UTF8     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r7.<init>(r3, r9)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r3 = r7.trim()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r9 = ""
            boolean r3 = r3.equals(r9)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            if (r3 == 0) goto L_0x0078
            r6 = r8
            goto L_0x007f
        L_0x0078:
            java.lang.String r3 = r7.trim()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r4.add(r3)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
        L_0x007f:
            byte[] r3 = new byte[r2]     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r7 = r5
            goto L_0x0044
        L_0x0083:
            ...
            goto L_0x0044
        L_0x0086:
            java.lang.String r0 = new java.lang.String     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.nio.charset.Charset r1 = UTF8     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r0.<init>(r3, r1)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            com.google.firebase.database.tubesock.WebSocketException r1 = new com.google.firebase.database.tubesock.WebSocketException     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r2.<init>()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r3 = "Unexpected long line in handshake: "
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.StringBuilder r0 = r2.append(r0)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r0 = r0.toString()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r1.<init>(r0)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            throw r1     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
        L_0x00a6:
            com.google.firebase.database.tubesock.WebSocketException r0 = new com.google.firebase.database.tubesock.WebSocketException     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r1 = "Connection closed before handshake was complete"
            r0.<init>(r1)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            throw r0     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
        L_0x00ae:
            com.google.firebase.database.tubesock.WebSocketHandshake r2 = r11.handshake     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.Object r3 = r4.get(r5)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r3 = (java.lang.String) r3     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r2.verifyServerStatusLine(r3)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r4.remove(r5)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.util.HashMap r2 = new java.util.HashMap     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r2.<init>()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.util.Iterator r3 = r4.iterator()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
        L_0x00c5:
            boolean r4 = r3.hasNext()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            if (r4 == 0) goto L_0x00ec
            java.lang.Object r4 = r3.next()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r4 = (java.lang.String) r4     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r6 = ": "
            r7 = 2
            java.lang.String[] r4 = r4.split(r6, r7)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r6 = r4[r5]     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.util.Locale r7 = java.util.Locale.US     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r6 = r6.toLowerCase(r7)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r4 = r4[r8]     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.util.Locale r7 = java.util.Locale.US     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.String r4 = r4.toLowerCase(r7)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r2.put(r6, r4)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            goto L_0x00c5
        L_0x00ec:
            com.google.firebase.database.tubesock.WebSocketHandshake r3 = r11.handshake     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r3.verifyServerHandshakeHeaders(r2)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            com.google.firebase.database.tubesock.WebSocketWriter r2 = r11.writer     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r2.setOutput(r0)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            com.google.firebase.database.tubesock.WebSocketReceiver r0 = r11.receiver     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r0.setInput(r1)     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            com.google.firebase.database.tubesock.WebSocket$State r0 = com.google.firebase.database.tubesock.WebSocket.State.CONNECTED     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r11.state = r0     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            com.google.firebase.database.tubesock.WebSocketWriter r0 = r11.writer     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            java.lang.Thread r0 = r0.getInnerThread()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r0.start()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            com.google.firebase.database.tubesock.WebSocketEventHandler r0 = r11.eventHandler     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r0.onOpen()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            com.google.firebase.database.tubesock.WebSocketReceiver r0 = r11.receiver     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            r0.run()     // Catch:{ WebSocketException -> 0x0139, all -> 0x0116 }
            goto L_0x013f
        L_0x0113:
            r0 = move-exception
            monitor-exit(r11)     // Catch:{ all -> 0x0113 }
        ...
        L_0x0116:
            r0 = move-exception
            com.google.firebase.database.tubesock.WebSocketEventHandler r1 = r11.eventHandler     // Catch:{ all -> 0x0143 }
            com.google.firebase.database.tubesock.WebSocketException r2 = new com.google.firebase.database.tubesock.WebSocketException     // Catch:{ all -> 0x0143 }
            ...
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0143 }
            java.lang.String r4 = r0.getMessage()     // Catch:{ all -> 0x0143 }
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0143 }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0143 }
            r2.<init>(r3, r0)     // Catch:{ all -> 0x0143 }
            r1.onError(r2)     // Catch:{ all -> 0x0143 }
            goto L_0x013f
        L_0x0139:
            r0 = move-exception
            com.google.firebase.database.tubesock.WebSocketEventHandler r1 = r11.eventHandler     // Catch:{ all -> 0x0143 }
            r1.onError(r0)     // Catch:{ all -> 0x0143 }
        L_0x013f:
            r11.close()
            return
        L_0x0143:
