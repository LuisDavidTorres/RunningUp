...
public class DefaultLogger implements Logger {
    ...
    public void onLogMessage(Logger.Level level, String str, String str2, long j) {
        if (shouldLog(level, str)) {
            ...
            int i = C12121.$SwitchMap$com$google$firebase$database$logging$Logger$Level[level.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C12121 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.database.logging.DefaultLogger.C12121.<clinit>():void");
        }
    }
