...
public class FirebaseStorage {
    ...
    FirebaseStorage(String str, FirebaseApp firebaseApp, Provider<InternalAuthProvider> provider, Provider<InternalAppCheckTokenProvider> provider2) {
        this.mBucketName = str;
        this.mApp = firebaseApp;
        this.mAuthProvider = provider;
        this.mAppCheckProvider = provider2;
        if (provider2 != null && provider2.get() != null) {
            provider2.get().addAppCheckTokenListener(new AppCheckTokenListener() {
    ...
    public InternalAppCheckTokenProvider getAppCheckProvider() {
        Provider<InternalAppCheckTokenProvider> provider = this.mAppCheckProvider;
        if (provider != null) {
            return provider.get();
        }
        return null;
