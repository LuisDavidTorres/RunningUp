    ...
    public void addListener(Activity activity, Executor executor, ListenerTypeT listenertypet) {
        ...
        synchronized (this.task.getSyncObject()) {
            ...
            if (activity != null) {
                ...
                ActivityLifecycleListener.getInstance().runOnActivityStopped(activity, listenertypet, new TaskListenerImpl$$ExternalSyntheticLambda0(this, listenertypet));
            }
        }
        if (z) {
            smartHandler.callBack(new TaskListenerImpl$$ExternalSyntheticLambda1(this, listenertypet, this.task.snapState()));
        }
    }
        ...
        if ((this.task.getInternalState() & this.targetStates) != 0) {
            ...
            for (Object next : this.listenerQueue) {
                ...
                if (smartHandler != null) {
                    smartHandler.callBack(new TaskListenerImpl$$ExternalSyntheticLambda2(this, next, snapState));
                }
            }
        }
    }
