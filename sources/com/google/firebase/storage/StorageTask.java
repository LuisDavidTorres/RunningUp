...
public abstract class StorageTask<ResultT extends ProvideError> extends ControllableTask<ResultT> {
    ...
    final TaskListenerImpl<OnCanceledListener, ResultT> cancelManager = new TaskListenerImpl<>(this, 256, new StorageTask$$ExternalSyntheticLambda9(this));
    final TaskListenerImpl<OnCompleteListener<ResultT>, ResultT> completeListener = new TaskListenerImpl<>(this, STATES_COMPLETE, new StorageTask$$ExternalSyntheticLambda10(this));
    private volatile int currentState = 1;
    final TaskListenerImpl<OnFailureListener, ResultT> failureManager = new TaskListenerImpl<>(this, 64, new StorageTask$$ExternalSyntheticLambda11(this));
    private ResultT finalResult;
    final TaskListenerImpl<OnPausedListener<? super ResultT>, ResultT> pausedManager = new TaskListenerImpl<>(this, 16, StorageTask$$ExternalSyntheticLambda1.INSTANCE);
    final TaskListenerImpl<OnProgressListener<? super ResultT>, ResultT> progressManager = new TaskListenerImpl<>(this, STATES_INPROGRESS, StorageTask$$ExternalSyntheticLambda2.INSTANCE);
    final TaskListenerImpl<OnSuccessListener<? super ResultT>, ResultT> successManager = new TaskListenerImpl<>(this, 128, new StorageTask$$ExternalSyntheticLambda12(this));
    ...
    public boolean tryChangeState(int[] r9, boolean r10) {
        ...
        L_0x00c8:
            ...
            android.util.Log.w(r0, r9)     // Catch:{ all -> 0x0100 }
            monitor-exit(r1)     // Catch:{ all -> 0x0100 }
            return r3
        L_0x0100:
            r9 = move-exception
    ...
    private <ContinuationResultT> Task<ContinuationResultT> continueWithImpl(Executor executor, Continuation<ResultT, ContinuationResultT> continuation) {
        ...
        this.completeListener.addListener((Activity) null, executor, new StorageTask$$ExternalSyntheticLambda4(this, continuation, taskCompletionSource));
    ...
    private <ContinuationResultT> Task<ContinuationResultT> continueWithTaskImpl(Executor executor, Continuation<ResultT, Task<ContinuationResultT>> continuation) {
        ...
        this.completeListener.addListener((Activity) null, executor, new StorageTask$$ExternalSyntheticLambda5(this, continuation, taskCompletionSource, cancellationTokenSource));
        return taskCompletionSource.getTask();
    }
    ...
    private <ContinuationResultT> Task<ContinuationResultT> successTaskImpl(Executor executor, SuccessContinuation<ResultT, ContinuationResultT> successContinuation) {
        CancellationTokenSource cancellationTokenSource = new CancellationTokenSource();
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource(cancellationTokenSource.getToken());
        this.successManager.addListener((Activity) null, executor, new StorageTask$$ExternalSyntheticLambda7(successContinuation, taskCompletionSource, cancellationTokenSource));
        return taskCompletionSource.getTask();
    }
    ...
    public Runnable getRunnable() {
        return new StorageTask$$ExternalSyntheticLambda3(this);
    }
