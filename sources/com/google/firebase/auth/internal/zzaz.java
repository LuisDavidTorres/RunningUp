...
import com.google.android.gms.internal.p006firebaseauthapi.zzae;
...
final class zzaz {
    ...
    public static Map<String, Object> zzb(String str) {
        ...
        if (zzd.size() < 2) {
            ...
            logger.mo13509e(valueOf.length() != 0 ? "Invalid idToken ".concat(valueOf) : new String("Invalid idToken "), new Object[0]);
            return new HashMap();
        }
        try {
            Map<String, Object> zzc = zzc(new String(Base64Utils.decodeUrlSafeNoPadding(zzd.get(1)), Key.STRING_CHARSET_NAME));
            return zzc == null ? new HashMap() : zzc;
        } catch (UnsupportedEncodingException e) {
            zza.mo13508e("Unable to decode token", e, new Object[0]);
            return new HashMap();
        }
    }
